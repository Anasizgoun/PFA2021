...
<link rel="stylesheet" href="acceuil.css" media="screen">
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-4ccc" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
        <a href="acceuil.php" data-page-id="71525385" class="u-image u-logo u-image-1" data-image-width="660" data-image-height="330" title="Page 1" data-animation-name="bounceIn" data-animation-duration="1000" data-animation-direction="" data-animation-delay="500">
...
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-grey-90 u-text-palette-1-base" href="acceuil.php#sec-2c95" data-page-id="71525385" style="padding: 10px 26px;">contact</a>
</li></ul>
          </div>
...
<ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-4"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="acceuil.php">acceuil</a></li>
...
<li class="u-nav-item"><a class="u-button-style u-nav-link" href="Contentieux.php#sec-492f" data-page-id="2940312430">mise en place des dossiers contentieux</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="acceuil.php#sec-2c95" data-page-id="71525385">contact</a>
</li></ul>
              </div>
            </div>
    ...
    <section class="u-align-left u-clearfix u-section-1" id="sec-d3c0">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-palette-1-base u-text-1">Gestion des s'affaires juridiques</h1>
        <h1 class="u-text u-text-default u-text-palette-2-base u-text-2">Gestion de service d'affaire juridique<span style="font-weight: 700;"></span>
        </h1>
...
if ($conn->connect_error) {
  die("Connection failed: " . $conn->connect_error);
     ...
     $sql = "SELECT `CIN`,`nom_prenom`,`nature_dossier`,`date_dossier` FROM `dossier fraude du courrant`";
         $result = $conn->query($sql);
        if ($result->num_rows > 0) {
     echo "<table><tr><th>CIN</th><th>nom et prénom</th><th>
    nature du dossier</th><th>date du dossier</th></tr>";
